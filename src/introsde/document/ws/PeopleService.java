 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.document.introsde/", wsdlLocation = "http://localhost:6902/ws/people?wsdl")
    ...
    extends Service
{
    ...
    public People getPeopleImplementationPort() {
        return super.getPort(new QName("http://ws.document.introsde/", "PeopleImplementationPort"), People.class);
    }
    ...
    public People getPeopleImplementationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.document.introsde/", "PeopleImplementationPort"), People.class, features);
    }
